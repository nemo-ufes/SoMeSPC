...
--%>
	...
	<ul>
		...
		<li data-jstree='{"icon":"<%=request.getContextPath()%>/naviox/images/planejamento.png"}' id="PlanoDeMedicaoIntegrado"><a href="<%=request.getContextPath()%>/naviox/wizard.jsp"> Novo Plano de Medição Integrado (Taiga)</a></li>
		<li data-jstree='{"icon":"<%=request.getContextPath()%>/naviox/images/cadastros.png"}' class="jstree-close">Cadastros
			<ul>
				<li data-jstree='{"icon":"<%=request.getContextPath()%>/naviox/images/organizacao.png"}' class="jstree-close">Organização
					<ul>
						<li data-jstree='{"icon":"<%=request.getContextPath()%>/naviox/images/organizacao.png"}' id="PapelRecursoHumano"><a href="<%=request.getContextPath()%>/m/PapelRecursoHumano"> Papéis dos Recursos Humanos</a></li>
						<li data-jstree='{"icon":"<%=request.getContextPath()%>/naviox/images/organizacao.png"}' id="RecursoHumano"><a href="<%=request.getContextPath()%>/m/RecursoHumano"> Recursos Humanos</a></li>
						...
						<li data-jstree='{"icon":"<%=request.getContextPath()%>/naviox/images/organizacao.png"}' id="ProcessoPadrao"><a href="<%=request.getContextPath()%>/m/ProcessoPadrao"> Processo de Software Padrão</a></li>
						...
						<li data-jstree='{"icon":"<%=request.getContextPath()%>/naviox/images/organizacao.png"}' id="ProcessoProjeto"><a href="<%=request.getContextPath()%>/m/ProcessoProjeto"> Processo de Software em Projeto</a></li>
						...
						<li data-jstree='{"icon":"<%=request.getContextPath()%>/naviox/images/organizacao.png"}' id="OcorrenciaProcesso"><a href="<%=request.getContextPath()%>/m/OcorrenciaProcesso"> Ocorrência de Processo de Software</a></li>
