...
//    
    ...
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_1, "NI – Quantos pontos de estória foram planejados para o projeto?", "ME – Pontos de Estória Planejados para o Projeto (PEPP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_1, "NI – Quantos pontos de estória foram concluídos no projeto?", "ME – Pontos de Estória Concluídos no Projeto (PECP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_1, "NI – Qual a taxa de conclusão de pontos de estória no projeto?", "ME – Taxa de Conclusão de Pontos de Estória no Projeto (TCPEP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_2, "NI – Quantas sprints foram planejadas para o projeto?", "ME – Número de Sprints Planejadas para o Projeto (NSPP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_2, "NI – Quantas sprints foram realizadas no projeto?", "ME – Número de Sprints Realizadas no Projeto (NSRP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_2, "NI – Qual a taxa de conclusão de sprintsnoprojeto?", " ME – Taxa de Conclusão dedeSprintsno Projeto (TCSP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_3, "NI – Quantas estórias foram planejadas para a sprint?", "ME – Número de Estórias Planejadas para a Sprint (NEPS)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_3, "NI – Quantas estórias foram concluídas na sprint?", "ME – Número de Estórias Concluídas na Sprint (NECS)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_3, "NI – Qual a taxa de conclusão de estórias na sprint?", "ME – Taxa de Conclusão de Estórias na Sprint (TCES)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_3, "NI – Quantos pontos de estória foram concluídos na sprint?", "ME – Pontos de Estória Concluídos na Sprint (PECS)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_3, "NI – Qual a taxa de conclusão de pontos de estórias na sprint?", "ME – Taxa de Conclusão de Pontos de Estórias na Sprint (TCPES)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_3, "NI – Quantas tarefas foram planejados para a sprint?", "ME – Número de Tarefas Planejadas para a Sprint (NTPS)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_3, "NI – Quantas tarefas foram concluídas na sprint?", "ME – Número de Tarefas Concluídas na Sprint (NTCS)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_3, "NI – Qual a taxa de conclusão de tarefas na sprint?", "ME – Taxa de Conclusão de Tarefas na Sprint (TCTS)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_3, "NI – Quantos pontos de estória foram planejados para a sprint?", "ME – Pontos de Estória Planejados para a Sprint (PEPS)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_4, "NI – Quantas sprints foram realizadas no projeto?", "ME – Número de Sprints Realizadas no Projeto (NSRP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_4, "NI – Quantas estórias foram concluídas para o projeto?", "ME – Número de Estórias Concluídas para o Projeto (NECP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_4, "NI – Qual o número médio de estórias concluídas por sprint no projeto?", "ME – Média de Estórias Concluídas por Sprint do Projeto (MECSP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_4, "NI – Quantas estórias foram concluídas para o projeto?", "ME – Número de Estórias Concluídas para o Projeto (NECP)", "Taiga"));
    itensPlanoDeMedicao.add(new ItemPlanoDeMedicaoDTO(OE, OM_4, "NI – Quantos pontos de estória foram concluídos no projeto?", "ME – Pontos de Estória Concluídos no Projeto (PECP)", "Taiga"));
