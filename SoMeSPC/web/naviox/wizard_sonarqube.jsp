...
<body ng-app="SoMeSPCWizardApp" <%=NaviOXStyle.getBodyClass(request)%> style="font-size: 12px; line-height: 15px;">
		...
		<tr>
			...
			<td valign="top">
				<div class="module-wrapper">
					...
					<div id="SoMeSPC-wizard" ng-controller="SonarQubeController">
						<h2>Conexão</h2>
						<fieldset>
	...
	<script type="text/javascript" src="js/angular/services/SoMeSPCService.js"></script>
