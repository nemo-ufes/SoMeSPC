	...
	<div class="panel panel-primary" style="margin-top: 20px;">
		...
		<div class="row" style="margin: 20px;">
			...
			<div class="col-md-6">
				...
				<p>
					<ul>
						<li>Selecione a(s) entidade(s) mensurável(is). O nome da entidade segue o padrão: Nome da Entidade Mensurável (Nome do Projeto). As entidades são agrupadas pelo Tipo de Entidade Mensurável;</li>
						<br/>
						<li>Selecione a medida (são listadas apenas as medidas que possuem medições para a(s) entidade(s) selecionada(s)). As medidas são agrupadas pelo Objetivo de Medição;</li>
						<br/>
