...
import org.medcep.model.analise_de_medicao.*;
...
public class AnaliseDeComportamentoDeProcesso
{
    ...
    @Id
    @TableGenerator(name = "TABLE_GENERATOR", table = "ID_TABLE", pkColumnName = "ID_TABLE_NAME", pkColumnValue = "ANALISE_COMP_PROC_ID", valueColumnName = "ID_TABLE_VALUE")
